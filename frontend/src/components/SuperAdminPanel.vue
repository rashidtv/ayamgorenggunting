    ...
    filteredPerformanceList() {
      let list = this.stallPerformance.filter(stall => {
        ...
        const matchesState = this.performanceStateFilter === 'All States' || 
                             (stall.state === this.performanceStateFilter)
...
.registrations-table-cell .status-badge {
  padding: 0.15rem 0.6rem;
  border-radius: 20px;
  font-size: 0.7rem;
  font-weight: 600;
...
.registrations-table-cell .status-badge.status-pending {
  background: #fef3c7;
  color: #92400e;
}

.registrations-table-cell .status-badge.status-approved {
  background: #d1fae5;
  color: #059669;
}

.registrations-table-cell .status-badge.status-rejected {
  background: #fee2e2;
  color: #dc2626;
}
